...
<body>
    <div class="login-page">
        <div class="login-visual">
            <div class="login-visual-content">
                ...
                <p class="login-visual-sub">Créez votre compte pour accéder à la plateforme</p>
            </div>
        </div>
        ...
        <div class="login-form-section">
            <div class="login-card">
                ...
                <form method="POST" action="{{ route('register.submit') }}">
                    ...
                    <div class="form-stack">
                        <div class="form-grid">
                            ...
                            <div class="field">
                                ...
                                <input id="prenom" type="text" name="prenom" value="{{ old('prenom') }}" placeholder="Votre prénom" required>
                            </div>
                            <div class="field">
                            ...
                            <div class="field">
                                ...
                                <input id="matricule" type="text" name="matricule" value="{{ old('matricule') }}" placeholder="Ex: MAT-001" required>
                            </div>
                            <div class="field full-width">
                                <label for="email">Email professionnel</label>
                                <input id="email" type="email" name="email" value="{{ old('email') }}" placeholder="exemple@entreprise.com" required>
                            </div>
                            <div class="field">
                    ...
                    <button type="submit" class="btn-full">Créer le compte</button>
                </form>
    ...
    function togglePassword(inputId, btnId) {
        ...
        const btn = document.getElementById(btnId) || event.target.closest('.password-toggle');
        const isPassword = input.type === 'password';
        input.type = isPassword ? 'text' : 'password';

        if (btn) {
            btn.querySelector('.eye-open').style.display = isPassword ? 'none' : 'block';
            btn.querySelector('.eye-slash').style.display = isPassword ? 'block' : 'none';
        }
    }
    </script>
</body>
