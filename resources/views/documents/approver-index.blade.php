...
<div class="card">
    <div class="card-header">
        <div>
            <div class="card-title">Documents a approuver</div>
            <div class="card-sub">Documents valides par le validateur et en attente de votre approbation.</div>
        </div>
    ...
    @if($documents->isEmpty())
        <div style="text-align:center;padding:2rem;color:var(--muted);">
            <div>Aucun document en attente d approbation.</div>
        </div>
    @else
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;gap:.25rem;flex-wrap:wrap;">
                                ...
                                <form method="POST" action="{{ route('workflow.approver.validate', $doc) }}">
                                    @csrf
                                    <button type="submit" class="btn btn-sm" style="border-color:rgba(34,197,94,0.5);">Approuver</button>
                                </form>
